...
---
> [!info]+ Definition
> **Input ports** are responsible for receiving incoming [[Packet|packets]], processing them at the physical and link layers, and forwarding them to the appropriate output port through the [[switching fabric]].
...
>
> **Note:** The input port must handle packets at line speed to avoid bottlenecks in the forwarding process.
